...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(data).done(ui.onSignUpSuccess).fail(ui.onError);
	};

	var onSignIn = function onSignIn(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.signIn(data).done(ui.onSignInSuccess).fail(ui.onError);
	};

	var onSignOut = function onSignOut(event) {
	  event.preventDefault();
	  api.signOut().done(ui.onSignOutSuccess).fail(ui.onError);
	};

	var onChangePassword = function onChangePassword(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.changePassword(data).done(ui.onChangePasswordSuccess).fail(ui.onError);
	};

	var onRemoveBookFromMyToReadList = function onRemoveBookFromMyToReadList(event) {
	  event.preventDefault();
	  var qualifiedBookID = $(this).parents().attr('id');
	  $(this).parent().remove();
	  ui.onRemoveBookFromMyToReadListSuccess();
	  api.removeBookFromMyToReadList(qualifiedBookID).done(ui.removeBookFromMyToReadList).fail(ui.onError);
	};
	...
	module.exports = {
	  ...
	  onRemoveBookFromMyToReadList: onRemoveBookFromMyToReadList
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addToMyToReadList = function addToMyToReadList(bookID) {
	  return $.ajax({
	...
	var showMyToReadList = function showMyToReadList() {
	  return $.ajax({
	    url: app.host + '/qualified_books',
	    method: 'GET',
	    headers: {
	...
	var removeBookFromMyToReadList = function removeBookFromMyToReadList(qualifiedBookID) {
	  return $.ajax({
	...
	var addNote = function addNote(params, qualifiedBookID) {
	  return $.ajax({
	    url: app.host + '/qualified_books/' + qualifiedBookID,
	    method: 'PATCH',
	    data: {
	...
	var removeNote = function removeNote(params, qualifiedBookID) {
	  return $.ajax({
	    url: app.host + '/qualified_books/' + qualifiedBookID,
	    method: 'PATCH',
	    data: {
	...
	var showMasterList = function showMasterList() {
	  return $.ajax({
	    url: app.host + '/books',
	    method: 'GET',
	    headers: {
	...
	module.exports = {
	  ...
	  addToMyToReadList: addToMyToReadList,
	  showMasterList: showMasterList,
	  showMyToReadList: showMyToReadList,
	  removeBookFromMyToReadList: removeBookFromMyToReadList,
	  addNote: addNote,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var masterList = __webpack_require__(8);
	var showToReadList = __webpack_require__(12);
	...
	var onRemoveBookFromMyToReadListSuccess = function onRemoveBookFromMyToReadListSuccess() {
	...
	module.exports = {
	  ...
	  onRemoveBookFromMyToReadListSuccess: onRemoveBookFromMyToReadListSuccess,
	  onError: onError
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var uiMasterList = __webpack_require__(9);
	var api = __webpack_require__(5);

	var onShowMasterList = function onShowMasterList() {
	  api.showMasterList().done(uiMasterList.onShowMasterListSuccess).fail(uiMasterList.error);
	};

	module.exports = {
	  onShowMasterList: onShowMasterList
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onAddRead = __webpack_require__(10);

	var onShowMasterListSuccess = function onShowMasterListSuccess(data) {
	  var id = void 0;
	  for (var i = 0; i < data.books.length; i++) {
	    id = data.books[i].id;
	    $('.master-list ol').append('<li data-id=' + id + '>' + '<span class=title>' + data.books[i].title + '</span>' + '<span class=author>' + data.books[i].author + '</span>' + '<form id=addToMyToReadList' + i + ' class=add-to-my-to-read-list>' + '<input type=submit value="Add to your to-read list">' + '</form>' + '</li>');
	...
	module.exports = {
	  onShowMasterListSuccess: onShowMasterListSuccess,
	  onError: onError
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var api = __webpack_require__(5);
	var onAddSuccess = __webpack_require__(11);

	var onAddToMyToReadList = function onAddToMyToReadList(event) {
	  event.preventDefault();
	  var bookID = $(this).parent().data('id');
	  api.addToMyToReadList(bookID).done(onAddSuccess.onAddToMyToReadListSuccess).fail(onAddSuccess.onErrorBook);
	};

	module.exports = {
	  onAddToMyToReadList: onAddToMyToReadList
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onAddToMyToReadListSuccess = function onAddToMyToReadListSuccess() {
	  showToReadList.onShowMyToReadList();
	  $('#signUpInOut').html("You really want to read that?? OK...");
	};

	var onErrorBook = function onErrorBook() {
	  $('#signUpInOut').html("You've already added that book!");
	};

	module.exports = {
	  onAddToMyToReadListSuccess: onAddToMyToReadListSuccess,
	  onErrorBook: onErrorBook
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var api = __webpack_require__(5);
	var uiToReadList = __webpack_require__(13);

	var onShowMyToReadList = function onShowMyToReadList() {
	  api.showMyToReadList().done(uiToReadList.onShowMyToReadListSuccess).fail(uiToReadList.onError);
	};
	...
	module.exports = {
	  onShowMyToReadList: onShowMyToReadList,
	  onError: onError
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onAddNote = __webpack_require__(14);

	var onShowMyToReadListSuccess = function onShowMyToReadListSuccess(data) {
	  $('#toReadList').children(':not("h3")').remove();
	  //Empty previous to-read list so it's not duplicated
	  var qualifiedBookID = void 0;
	  ...
	  for (var i = 0; i < data.length; i++) {
	    ...
	    '<span class=author>' + data[i].book.author + '</span>' + '<div id=noteSpace' + qualifiedBookID + ' class="note-space-here">' + data[i].notes + '</div>' +
	...
	module.exports = {
	  onShowMyToReadListSuccess: onShowMyToReadListSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var api = __webpack_require__(5);
	var uiAddNote = __webpack_require__(15);
	var getFormFields = __webpack_require__(4);

	var onAddNote = function onAddNote(event) {
	  event.preventDefault();
	  var qualifiedBookID = $(this).parents().attr('id');
	  var params = getFormFields(event.target);
	  api.addNote(params, qualifiedBookID).done(uiAddNote.onAddNoteSuccess).fail(uiAddNote.onError);
	};

	var onRemoveNote = function onRemoveNote(event) {
	  event.preventDefault();
	  var qualifiedBookID = $(this).parents().attr('id');
	  console.log(qualifiedBookID);
	  var params = { notes: "Your note shows here!" };
	  api.removeNote(params, qualifiedBookID).done(uiAddNote.onRemoveNoteSuccess).fail(uiAddNote.onError);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onRemoveNoteSuccess = function onRemoveNoteSuccess(data) {
	  var qualifiedBookID = data.qualified_book.id;
	  $('#addNote' + qualifiedBookID).show();
	  $('#removeNote' + qualifiedBookID).hide();
	...
	var onAddNoteSuccess = function onAddNoteSuccess(data) {
	  ...
	  $('#removeNote' + qualifiedBookID).on('submit', function (event) {
	    ...
	    var qualifiedBookID = $(this).parents().attr('id');
	    var params = { notes: "Your note shows here!" };
	    api.removeNote(params, qualifiedBookID).done(onRemoveNoteSuccess).fail(onError);
	  });
	};

	module.exports = {
	  onAddNoteSuccess: onAddNoteSuccess,
	  onRemoveNoteSuccess: onRemoveNoteSuccess,
	  onError: onError
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
